...
from se_theory_neutral_substrate.ref_utils import (
    LeanDecl,
    extract_decls,
    extract_for_section,
    find_repo_root,
...
def test_run_scaffold_adds_stub_for_new_symbol(
    ...
    monkeypatch.setattr(
        "se_theory_neutral_substrate.reference.find_repo_root", lambda: repo
    )
...
def test_run_scaffold_missing_index_returns_1(
    ...
    monkeypatch.setattr(
        "se_theory_neutral_substrate.reference.find_repo_root", lambda: tmp_path
    )
